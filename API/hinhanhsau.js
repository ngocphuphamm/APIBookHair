...
async function crawldata() {
  ...
  await request('https://zombieclothingstore.com/collections/mu', (err,res,html)=>{
  ...
  let count = 40 ;
    ...
    if(!err && res.statusCode)
    {
        ...
        fs.writeFileSync('hinhanhhover.json', JSON.stringify(dataJson)); // lưu dữ liệu vào file data.json
    }
    else{
        console.log(err);
    }
