...
async function crawldata() {
 await request('https://zombieclothingstore.com/collections/ao-thun-so-mi?page=2', (err,res,html)=>{
    let count = 60 ;
    let countP = 30 ;
    ...
    if(!err && res.statusCode)
    {
        ...
        fs.writeFileSync('hinhanhaosomi.json', JSON.stringify(dataJson)); // lưu dữ liệu vào file data.json
    }
    else{
        console.log(err);
    }
