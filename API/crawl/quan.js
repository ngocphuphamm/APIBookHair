...
async function crawldata() {
 await request('https://zombieclothingstore.com/collections/quan', (err,res,html)=>{
    let count = 60 ;
    ...
    //         // const productDes = "Vải cotton hút ẩm tốt ,mịn mát,co giãn, dày vừa ko bí, mang đến cảm giác dễ chịu cho người sử dụng.";
        ...
        fs.writeFileSync('quan.json', JSON.stringify(dataJson)); // lưu dữ liệu vào file data.json
    }
    else{
        console.log(err);
    }
