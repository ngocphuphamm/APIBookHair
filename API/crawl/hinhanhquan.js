...
async function crawldata() {
 await request('https://zombieclothingstore.com/collections/quan?page=2', (err,res,html)=>{
    let count = 140 ;
    let countP = 70 ;
    ...
    if(!err && res.statusCode)
    {
        ...
        fs.writeFileSync('hinhanhquan.json', JSON.stringify(dataJson)); // lưu dữ liệu vào file data.json
    }
    else{
        console.log(err);
    }
